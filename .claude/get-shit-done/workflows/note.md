...
- **Global scope**: `/Users/williamroe/development/projects/agenic_coder/finally/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/williamroe/development/projects/agenic_coder/finally/.claude/notes/`)
...
2. Glob `/Users/williamroe/development/projects/agenic_coder/finally/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/williamroe/development/projects/agenic_coder/finally/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/williamroe/development/projects/agenic_coder/finally/.claude/notes/` — works in any directory
