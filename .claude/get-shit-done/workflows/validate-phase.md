...
```
Task(
  prompt="Read /Users/williamroe/development/projects/agenic_coder/finally/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/williamroe/development/projects/agenic_coder/finally/.claude/get-shit-done/templates/VALIDATION.md`
