...
**YOU ARE IN: `finally/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/finally/` (rig root) or other directories
...
**Your mail address:** `finally/polecats/chrome`
**Your rig:** finally
**Your Witness:** `finally/witness`
...
| Ask Witness for help | `gt mail send finally/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`finally/witness`) when:
...
```bash
gt mail send finally/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
